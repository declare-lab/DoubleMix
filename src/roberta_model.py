...
class Roberta_model(nn.Module):
    def __init__(self, num_labels=3, mix_option=False, output_attentions=False):
        ...
        if mix_option:
            self.model = RobertaModel4Mix.from_pretrained('roberta-base', output_attentions=self.output_attentions)          
        else:
            self.model = RobertaModel.from_pretrained('roberta-base', output_attentions=self.output_attentions)
